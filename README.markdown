...
3. Get **mirlight** using `git clone` [HowTo](http://github.com/guides/using-git-and-github-for-the-windows-for-newbies) or download an archive usings links above.
...
#### Szybki start dla użytkowników Windows®y
...
3. Pobierz **mirlight** używając `git clone` [HowTo](http://github.com/guides/using-git-and-github-for-the-windows-for-newbies) albo pobierz archiwum używając linków z zakładek u góry strony.
